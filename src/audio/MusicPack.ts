  ...
  private static catalog: TrackCatalogEntry[] = [
    {
      id: 'first-contact',
      title: 'FIRST CONTACT',
      artist: 'PLAYHEAD AUDIO LABS',
      genre: 'MELODIC SYNTH // FLOW',
      bpm: 120,
      duration: 72,
      difficulty: 1,
      difficultyLabel: 'FLOW',
      description: 'Crafted as the quintessential onboarding course. Features gentle rhythm hops, smooth acceleration, and introductory downhill surf glides.',
      accentColor: '#00f0ff',
      paletteKey: 'ICE',
      tags: ['ONBOARDING', 'SYNTHWAVE', 'FLOW', 'RECOMMENDED'],
      isFirstContact: true,
    ...
    },
    {
      ...
      description: 'Punchy 4-on-the-floor kicks, escalating snare build-up, and a massive drop setpiece with steep downhill surf transitions and launch pads.',
      accentColor: '#ff2a55',
      paletteKey: 'SIGNAL_RED',
      tags: ['ELECTRO', 'HIGH ENERGY', 'SURF HEAVY'],
    ...
    },
    {
      ...
      description: '174 BPM syncopated breakbeats, reese basslines, and fast aerial strafe trajectories demanding precise rhythm timing.',
      accentColor: '#b8ff00',
      paletteKey: 'ACID',
      tags: ['D&B', 'BREAKBEAT', 'FAST PACED'],
      generate: (sr) => synthesizeNeuralDrift(66, sr),
      generatePreview: (sr) => synthesizeNeuralDrift(6, sr)
    },
    {
      id: 'chrono-cataclysm',
      title: 'CHRONO CATACLYSM',
      artist: 'MONOLITH DIVISION',
      genre: 'INDUSTRIAL HALF-TIME // BASS',
      bpm: 85,
      duration: 76,
      difficulty: 5,
      difficultyLabel: 'EXPERT',
      description: 'Cathedral drops, fractured monolith setpieces, and aggressive technical surf curves with heavy half-time sub bass.',
      accentColor: '#ff9e00',
      paletteKey: 'EMBER',
      tags: ['HALF-TIME', 'INDUSTRIAL', 'TECHNICAL'],
    ...
    },
    {
      id: 'voidwalker',
      title: 'VOIDWALKER',
      artist: 'CELESTIAL PROTOCOL',
      genre: 'CELESTIAL AMBIENT // FLOW',
      bpm: 72,
      duration: 70,
      difficulty: 2,
      difficultyLabel: 'ETHEREAL',
      description: 'Evolving ethereal pads, serene floating jumps, and starry low-gravity airspace with deep sub pulses.',
      accentColor: '#c084fc',
      paletteKey: 'ULTRAVIOLET',
      tags: ['AMBIENT', 'CHILL', 'SPACIAL'],
